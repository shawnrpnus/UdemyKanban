...
import { Form, Button, DatePicker, Input, Select, Typography, Alert, Spin } from "antd";
...
export interface IUpdateProjectTaskProps
	...
	clearStateBacklog: typeof clearStateBacklog;
}
...
> {
	...
	public render() {
		...
		return (
			<Spin spinning={Object.keys(this.props.projectTaskToUpdate).length === 0}>
							...
							<Form onSubmit={this.handleSubmit}>
								...
								>
									{getFieldDecorator("summary", {
										initialValue: projectTaskToUpdate.summary
